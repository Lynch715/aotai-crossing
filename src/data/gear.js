...
export const GEAR = [
  ...
  // 份数 = 一次采购包含的可消耗份数（源文档食物表按 7 天计）。
  // 商店按 份数 入包、tier.重量 是整包重量——没有这个字段的话，商店按 数量:1
  // 入包，dailyUpkeep 每天扣 2 份，第一晚就把「7 天的主粮」扣光了。
  { id: 'staple_food', 名称: '高能量棒/压缩干粮', 类别: '食物', 每日消耗: 2, 份数: 14, 档次: [
    { 档: '经济', 价格: 150, 重量: 2.5 }, { 档: '主流', 价格: 400, 重量: 2.0 }] },
  { id: 'freeze_dried', 名称: '冻干速食餐', 类别: '食物', 热食: true, 份数: 6, 档次: [
    { 档: '主流', 价格: 300, 重量: 1.2 }, { 档: '高端', 价格: 600, 重量: 0.8 }] },
  { id: 'trail_snack', 名称: '坚果、巧克力、牛肉干（路餐）', 类别: '食物', 冷食: true, 份数: 8, 档次: [
    { 档: '通用', 价格: 150, 重量: 1.0 }] },
...
export const EXTRA_GEAR = [
  { id: 'extra_staple', 名称: '额外主粮 +3 天', 类别: '扩充·补给', 每日消耗: 0, 份数: 6,
    作用: '超期不断粮', 档次: [{ 档: '通用', 价格: 180, 重量: 1.2 }] },
  { id: 'extra_freeze_dried', 名称: '额外冻干餐 ×3', 类别: '扩充·补给', 热食: true, 份数: 3,
  ...
  { id: 'extra_canister', 名称: '额外气罐 ×2', 类别: '扩充·补给', 份数: 2,
